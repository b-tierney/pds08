...
ggsave('richness_div_analysis/rnr_div_simpson_allclades.pdf',width=15,height=20)
...
ggsave('richness_div_analysis/rnr_div_simpson_base_allclades.pdf',width=15,height=20)
...
ggsave('richness_div_analysis/rnr_div_simpson_end_allclades.pdf',width=15,height=20)
...
write.csv(glm_output,'~/Desktop/google_drive/My Drive/pds08/richness_div_analysis/glm_output_metaphlan_simpson.csv')
